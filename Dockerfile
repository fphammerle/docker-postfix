...
ARG POSTFIX_PACKAGE_VERSION=3.11.6-r0
...
# https://git.alpinelinux.org/aports/log/main/ca-certificates?h=3.24-stable
ARG MOZILLA_CA_CERT_STORE_PACKAGE_VERSION=20260611-r0
